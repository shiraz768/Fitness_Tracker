...
const Slider = () => {
  ...
  return (
    <div className="w-[90%] mx-auto mt-15 h-full" data-aos="fade-up">
      <p className="text-3xl font-bold text-white text-center py-16">
        Why Choose Us
      </p>
      <div className="mt-6">
        <Carousel
        ...
        >
          {sliderContent.map((item, key) => (
            <div className="py-10 bg-black text-white w-full" key={key}>
                  ...
                  <div className="flex flex-col gap-4 shadow-lg py-8 px-6 mx-4 rounded-xl bg-primary/10 relative dark:bg-dark">
                    ...
                    <div className="flex flex-col items-center gap-4">
                      <div className="space-y-3">
                        <p className="text-xs text-gray-300">{`${item.para}`}</p>
