...
const AddMeal = () => {
  ...
  return (
    <>
      <div className="max-w-md mx-auto mt-10 p-6 bg-white  text-black rounded-lg text-center shadow-md">
      ...
      <form onSubmit={handleMeal}>
        ...
        <button
          type="submit"
          className="`w-full bg-teal-600 text-white py-2 px-4 rounded-lg transition-colors cursor-pointer"
        >
            Add Meal
        </button>
      </form>
